...
const out = process.env.CAPTURE_OUT || 'test-results/capture';
...
await until(3.3); await shot('r1-step'); await until(9.3); await shot('r1-clang'); await until(15.5); await shot('r1-charge'); await until(17.2); await shot('r1-fly1'); await until(17.8); await shot('r1-fly2'); await until(18.3); await shot('r1-impact'); await until(18.9); await shot('r1-after');
...
await until(30.5); await shot('r2-charge'); await until(33.0); await shot('r2-slam'); await until(34.8); await shot('r2-slash'); await until(36); await shot('r2-block');
