...
「60秒魔法ゲーム」の試作です。手（またはマウス）で線を描き、声で唱えた言葉から魔法を作り、騎士へ放ちます。設計仕様の一回目（0〜24秒）、防御の回（24〜40秒）、とどめの回（40〜60秒）の60秒を通して遊べ、60秒で魔導書（結果画面）が出ます。とどめの見せ方と騎士の崩れ落ちは別途作っています。QRの先の公開ページ、展示の連続運転は次の段階です。
