...
import { BATTLE_END, ENEMY_CHARGE_FROM_MS, ENEMY_MOVES, ENEMY_SLAM_MS, FINAL_BLOW_MS, FINISH_COLLAPSE_MS, FINISH_HIT_MS, FINISH_HIT_OFFSETS_MS, ROUNDS } from '../game/rounds';
...
export class Knight {
  ...
  render(ms:number,active:boolean,recipe:Recipe|null,amount=0,power?:number,guardStyle:'block'|'reflect'|'erase'|null=null) {
    ...
    const kick=viewKick(ms,active,this.calm||this.motion.matches);
