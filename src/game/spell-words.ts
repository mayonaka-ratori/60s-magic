...
const SPELL_TERMS: readonly SpellTerm[] = [
  ...
  // 子どもや文字入力の人は、かなやカタカナで唱える。漢字の語と同じ意味に読む。
  // 一文字のかな（「ひ」など）はほかの語に混ざるので入れない。
  { word: 'ほのお', kind: 'element', element: 'fire' },
  { word: 'ホノオ', kind: 'element', element: 'fire' },
  { word: 'もやせ', kind: 'element', element: 'fire', purpose: 'attack' },
  { word: 'こおり', kind: 'element', element: 'ice' },
  { word: 'コオリ', kind: 'element', element: 'ice' },
  { word: 'こおれ', kind: 'element', element: 'ice' },
  { word: 'いなずま', kind: 'element', element: 'lightning' },
  { word: 'イナズマ', kind: 'element', element: 'lightning' },
  { word: 'かぜ', kind: 'element', element: 'wind' },
  { word: 'カゼ', kind: 'element', element: 'wind' },
  { word: 'あらし', kind: 'element', element: 'wind' },
  { word: 'ひかり', kind: 'element', element: 'light' },
  { word: 'ヒカリ', kind: 'element', element: 'light' },
  { word: 'やみ', kind: 'element', element: 'dark' },
  { word: 'ヤミ', kind: 'element', element: 'dark' },
  { word: 'かげ', kind: 'element', element: 'dark' },
  ...
  { word: 'かべ', kind: 'form', form: 'wall', purpose: 'defend' },
  { word: 'カベ', kind: 'form', form: 'wall', purpose: 'defend' },
  { word: 'けっかい', kind: 'form', form: 'dome', purpose: 'defend' },
  { word: 'つつめ', kind: 'form', form: 'dome' },
  { word: 'なみ', kind: 'form', form: 'wave' },
  { word: 'つらぬけ', kind: 'form', form: 'beam', purpose: 'attack' },
  { word: 'たま', kind: 'form', form: 'orb' },
  { word: 'わかれ', kind: 'form', form: 'swarm' },
  ...
  { word: 'まもれ', kind: 'purpose', purpose: 'defend' },
  { word: 'まもって', kind: 'purpose', purpose: 'defend' },
  { word: 'ふせげ', kind: 'purpose', purpose: 'defend' },
  { word: 'しばれ', kind: 'purpose', purpose: 'bind' },
  { word: 'つよくな', kind: 'purpose', purpose: 'enhance' },
  { word: 'たおせ', kind: 'purpose', purpose: 'attack' },
  { word: 'うて', kind: 'purpose', purpose: 'attack' },
