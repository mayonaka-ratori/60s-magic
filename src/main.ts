...
let endedInput=false,requested=false,resultShown=false,lastUi=0,feedback:string|null=null,lastCameraLatency=0,revealed=false,damaged=false;
...
async function begin(isDemo=false) {
  ...
  inputLags.length=0;pendingInputAt=0;revealed=false;damaged=false;
